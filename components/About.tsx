    ...
    <section id="about" className="container-editorial py-28 md:py-40">
      <div className="grid gap-16 md:grid-cols-12">
        <div className="md:col-span-3">
          <FadeUp className="flex items-center gap-3 font-sans text-xs uppercase tracking-[0.3em] text-paper-dim">
        ...
        <div className="md:col-span-9">
          <SplitReveal
            text={philosophy}
            as="p"
            className="font-serif text-2xl font-light leading-[1.35] text-paper md:text-4xl md:leading-[1.3]"
            stagger={0.012}
          />
          ...
          <div className="mt-20 grid gap-x-10 gap-y-10 border-t hairline pt-12 sm:grid-cols-3">
            {focus.map((f, i) => (
              <FadeUp key={f.k} delay={i * 0.06}>
                ...
                <p className="mt-4 font-sans text-base leading-relaxed text-paper-soft">
                  {f.v}
                </p>
              </FadeUp>
            ))}
